...
export function RatingChange({standing}:{standing?:import("@arena/shared").MatchStanding}) {return standing?.ratingDelta===undefined?null:<p className="rating-change">MMR {standing.ratingBefore} → {standing.ratingAfter} ({standing.ratingDelta>=0?'+':''}{standing.ratingDelta})</p>;}
