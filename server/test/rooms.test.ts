...
import type { ClientToServerEvents, ServerToClientEvents, RoomState, PublicRoom, Result } from "@arena/shared";
...
test("successful start emits one readiness event and returns to WAITING",async()=>{
...
test("leaving during STARTING cancels the placeholder transition safely",async()=>{
